...
const navigationInnerRuntimeConfig = window.RUNTIME_CONFIG || {};
const testPagesRoot2 = navigationInnerRuntimeConfig.TEST_PAGES_ROOT_2 || 'https://test-pages.privacytests2.org';
